      ...
      <div className="container">
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl bg-gradient-soft p-10 shadow-soft border border-border">
            ...
            <Button variant="hero" size="lg" className="mt-6">Quiero vender mis productos</Button>
          </div>
          <div className="rounded-3xl bg-gradient-leaf p-10 shadow-leaf text-primary-foreground">
            ...
            <Button variant="harvest" size="lg" className="mt-6">Empezar mi cesta semanal</Button>
          </div>
        </div>
      </div>
    </section>;
